...
REPO=${REPO:-"evil-morfar/RCLootCouncil_Classic"}
...
PAYLOAD=$(jq -n \
    ...
    embeds: [{
        title: ("RCLootCouncil Classic v" + $version),
        description: ("-# A new version of RCLootCouncil Classic is available!\n" + $changelog),
        color: 16547409,
        ...
        fields: [
            {
                name: "Download",
                value: ("[CurseForge](https://www.curseforge.com/wow/addons/rclootcouncil-classic/files)"
                + " | [Wago](https://addons.wago.io/addons/rclootcouncil-classic/versions)"
